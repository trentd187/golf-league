...
// Re-export the API/display converters so existing call sites that import them
// from "@/components/DateInput" keep working (canonical impls live in utils/dateInput).
