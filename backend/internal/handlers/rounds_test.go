...
func TestGetRound_MissingAuth(t *testing.T) {
	app := newSingleRouteApp(http.MethodGet, "/rounds/:roundId", handlers.GetRound(nil))
	resp, err := app.Test(
...
func TestUpdateRound_MissingAuth(t *testing.T) {
	app := newSingleRouteApp(http.MethodPatch, "/rounds/:roundId", handlers.UpdateRound(nil))
	resp, err := app.Test(
...
func TestAddGroupMember_MissingAuth(t *testing.T) {
	app := newSingleRouteApp(http.MethodPost,
		"/rounds/:roundId/groups/:groupId/members",
		handlers.AddGroupMember(nil))
	resp, err := app.Test(
...
func TestRemoveGroupMember_MissingAuth(t *testing.T) {
	app := newSingleRouteApp(http.MethodDelete,
		"/rounds/:roundId/groups/:groupId/members/:userId",
		handlers.RemoveGroupMember(nil))
	resp, err := app.Test(
